...
>## 0. :goal_net: Purpose 
A runbook is an operational reference which is used to describe an AIS micro service in a deployed environment including Operational information, dependencies and infrastructure details. It should be easy to read, consistent across all applications, and accurate. 
